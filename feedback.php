...
<div class="col-md-10">
<a href="mailto:ishikasigdel1818@gmail.com<" style="color:#000000">ishikasigdel1818@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style=" "><span style="color:orange">Developers</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Ishika Sigdel" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.facebook.com/ishika.sigdel.5" style="color:#202020; font-size:18px" title="Find on Facebook">Ishika Sigdel</a>
		<h4 style="color:#202020; font-size:16px" class="title1">9806851405</h4>
		<h4 style=" ">ishikasigdel1818@gmail.com</h4>
		<h4 style=" ">Lumbini ICT Campus</h4></div></div>
		</p>
      </div>
