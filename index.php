    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="https://www.facebook.com/ishika.sigdel.5" style="color:#202020;
     font-size:18px" title="Find on Facebook">Ishika Sigdel</a>
		<h4 style="color:#202020; font-size:16px" class="title1">9806851405</h4>
		<h4 style=" ">ishikasigdel1818@gmail.com</h4>
		<h4 style=" ">Lumbini ICT Campus,Gaindakot</h4></div></div>
		</p>
      </div>
